...
public class FontInfoDetector {
    private static final String TAG = "FontInfoDetector";
    ...
    public Map<String,File[]> collectFonts(Iterable<File> files) {
        ...
        for (File f : files) {
            try {
                final FontInfo info = detectInfo(f);
    ...
    public FontInfo detectInfo(File file) throws IOException {
    ...
    private static class TableInfo {
        ...
        TableInfo(byte[] buffer, int off) throws IOException {
            ...
            Offset = FontInfoDetector.getInt32(buffer, off + 8);
            Length = FontInfoDetector.getInt32(buffer, off + 12);
        }
    }
    ...
    private FontInfo readFontInfo(TableInfo nameInfo) throws IOException {
