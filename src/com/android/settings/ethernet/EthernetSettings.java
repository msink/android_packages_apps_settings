...
public class EthernetSettings extends SettingsPreferenceFragment {
    ...
    private boolean isEthernetEnabled() {
        return Settings.Secure.getInt(getContentResolver(),
               Settings.Secure.ETHERNET_ON, 1) == 1;
    }
    ...
    public void getEthInfoFromStaticIP() {
        mEthIpAddress = System.getString(getContentResolver(), System.ETHERNET_STATIC_IP);
        mEthNetmask   = System.getString(getContentResolver(), System.ETHERNET_STATIC_NETMASK);
        mEthGateway   = System.getString(getContentResolver(), System.ETHERNET_STATIC_GATEWAY);
        mEthdns1      = System.getString(getContentResolver(), System.ETHERNET_STATIC_DNS1);
        mEthdns2      = System.getString(getContentResolver(), System.ETHERNET_STATIC_DNS2);
    }
    ...
    private boolean isUsingStaticIp() {
        return System.getInt(getContentResolver(), System.ETHERNET_USE_STATIC_IP, 0) == 1;
    }
