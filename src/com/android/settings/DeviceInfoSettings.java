...
public class DeviceInfoSettings extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        PreferenceGroup parent = (PreferenceGroup)findPreference("parent");
        if (!Build.PRODUCT.equals("K20Pro")) {
            Preference adobeInfo = parent.findPreference("build_adobe");
            parent.removePreference(adobeInfo);
        }
        if (!Build.PRODUCT.equals("Imcosys")) {
            Preference sofewareInfo = parent.findPreference("software_information");
            parent.removePreference(sofewareInfo);
        }
    }
